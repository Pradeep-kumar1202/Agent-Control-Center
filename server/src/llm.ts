...
export interface AskOptions {
  ...
  system?: string;
  /** AbortSignal — when aborted, kills the claude subprocess immediately. */
  signal?: AbortSignal;
  /**
...
export interface StreamChunk {
  ...
  /** Assistant text delta (type: "text") or extended-thinking delta (type: "thinking"). */
  text?: string;
...
export function askStream(
  ...
  return new Promise((resolve, reject) => {
    ...
    // Wire AbortSignal so callers can kill the subprocess on client disconnect.
    if (opts.signal) {
