 ...
 *
 * Two endpoints:
 *   POST /skills/integration/classify  — Sonnet reads SDK doc, returns SdkClassification (JSON)
 *   POST /skills/integration/generate  — Takes confirmed classification + spec, runs coder+reviewer (SSE)
 *
 * Architecture:
